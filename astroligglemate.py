                ...
                for prediction in horoscope_list:
                    ...
                    if translate_option != "แค่ภาษาไทยก็พอแล้ว 😎":
                        ...
                        for row in prediction_row:
                            ...
                            ตัวอย่างการแปล:
                            ต้นฉบับ: "เจ้านายชมเชย! ( • ̀ω•́ )✧ แต่ไม่ได้ขึ้นเงินเดือน ╥‸╥"
                            ...
                            prediction_row[f"Prediction_{translate_option}"] = translation_response.choices[0].message.content
