...
คุณจะได้รับชื่อเพื่อน วันเกิด (วันในสัปดาห์) และนิสัยเด่นของเพื่อน
...
4. ความรัก
5. โชคลาภ
6. Lucky Item ประจำสัปดาห์ (คนที่เกิดในแต่ละวันจะได้ Lucky Item ต่างกันไปตามนิสัยเด่นของเพื่อนที่ให้มา แต่สีของ item จะเหมือนกัน โดยคนเกิดวันจันทร์-สีเหลือง วันอังคาร-สีชมพู วันพุธ-สีเขียว วันพฤหัสบดี-สีส้ม วันศุกร์-สีฟ้า วันเสาร์-สีม่วง วันอาทิตย์-สีแดง)
จากนั้นส่งคำทำนายในรูปแบบ JSON array 
ตัวอย่างเช่น คุณได้รับชื่อเพื่อน "เจได" วันเกิด "วันอาทิตย์" นิสัยเด่น "โสด สู้งาน ชอบเล่นเกม" คุณจะต้องสร้างคำทำนายและส่งคำทำนายในรูปแบบ JSON array ที่มีโครงสร้างดังต่อไปนี้:
[
...
if st.button("(๑'ᵕ'๑)⸝*🔮 ดูดวงง!"):
    if not user_api_key:
        ...
        st.error("กรุณากรอกข้อมูลเพื่อนอย่างน้อย 1 คนน้า~ (｡- .•̀ )⟡˖ ࣪⋆")
    else:
